...
const DM = (() => {
  ...
  let listings = [
    {
      ...
      location: 'Dubai',
      seller: 'GTA Cars',
      sellerLogo: 'logos/gta-cars.webp',
      phone: '+97143388855',
      verified: true,
      featured: true,
      warranty: true,
      ...
      mainImg: 'gta-images/gta-001-img04.webp',
      images: [
        'gta-images/gta-001-img04.webp',
        'gta-images/gta-001-img05.webp',
        'gta-images/gta-001-img03.webp',
        'gta-images/gta-001-img07.webp',
        'gta-images/gta-001-img01.webp',
        'gta-images/gta-001-img02.webp',
        'gta-images/gta-001-img06.webp',
        'gta-images/gta-001-img08.webp',
        'gta-images/gta-001-img09.webp',
        'gta-images/gta-001-img10.webp',
        'gta-images/gta-001-img11.webp',
        'gta-images/gta-001-img12.webp',
        'gta-images/gta-001-img13.webp'
      ]
    },
    {
      id: 'gta-002',
      ...
      lat: 25.1442, lng: 55.2248,
      locationAddress: 'Al Quoz Industrial Area 1, Al Quoz, Dubai, UAE',
      mainImg: 'gta-images/gta-002-img04.webp',
      images: [
        'gta-images/gta-002-img04.webp',
        'gta-images/gta-002-img05.webp',
        'gta-images/gta-002-img03.webp',
        'gta-images/gta-002-img01.webp',
        'gta-images/gta-002-img02.webp',
        'gta-images/gta-002-img06.webp',
        'gta-images/gta-002-img07.webp',
        'gta-images/gta-002-img08.webp',
        'gta-images/gta-002-img09.webp',
        'gta-images/gta-002-img10.webp',
        'gta-images/gta-002-img11.webp',
        'gta-images/gta-002-img12.webp'
      ]
    },
    {
      id: 'gta-003',
      ...
      lat: 25.1442, lng: 55.2248,
      locationAddress: 'Al Quoz Industrial Area 1, Al Quoz, Dubai, UAE',
      mainImg: 'gta-images/gta-003-img04.webp',
      images: [
        'gta-images/gta-003-img04.webp',
        'gta-images/gta-003-img05.webp',
        'gta-images/gta-003-img03.webp',
        'gta-images/gta-003-img01.webp',
        'gta-images/gta-003-img02.webp',
        'gta-images/gta-003-img06.webp',
        'gta-images/gta-003-img07.webp',
        'gta-images/gta-003-img08.webp',
        'gta-images/gta-003-img09.webp',
        'gta-images/gta-003-img10.webp',
        'gta-images/gta-003-img11.webp',
        'gta-images/gta-003-img12.webp'
      ]
    },
    {
      id: 'gta-004',
      ...
      lat: 25.1442, lng: 55.2248,
      locationAddress: 'Al Quoz Industrial Area 1, Al Quoz, Dubai, UAE',
      mainImg: 'gta-images/gta-004-img04.webp',
      images: [
        'gta-images/gta-004-img04.webp',
        'gta-images/gta-004-img05.webp',
        'gta-images/gta-004-img03.webp',
        'gta-images/gta-004-img01.webp',
        'gta-images/gta-004-img02.webp',
        'gta-images/gta-004-img06.webp',
        'gta-images/gta-004-img07.webp',
        'gta-images/gta-004-img08.webp',
        'gta-images/gta-004-img09.webp',
        'gta-images/gta-004-img10.webp',
        'gta-images/gta-004-img11.webp',
        'gta-images/gta-004-img12.webp'
      ]
    },
    {
      id: 'gta-005',
      ...
      lat: 25.1442, lng: 55.2248,
      locationAddress: 'Al Quoz Industrial Area 1, Al Quoz, Dubai, UAE',
      mainImg: 'gta-images/gta-005-img04.webp',
      images: [
        'gta-images/gta-005-img04.webp',
        'gta-images/gta-005-img05.webp',
        'gta-images/gta-005-img03.webp',
        'gta-images/gta-005-img01.webp',
        'gta-images/gta-005-img02.webp',
        'gta-images/gta-005-img06.webp',
        'gta-images/gta-005-img07.webp',
        'gta-images/gta-005-img08.webp',
        'gta-images/gta-005-img09.webp',
        'gta-images/gta-005-img10.webp',
        'gta-images/gta-005-img11.webp',
        'gta-images/gta-005-img12.webp'
      ]
    },
    {
  ...
  function toLegacyShape(row, sellerProfile) {
    ...
    // Pick a sensible seller logo from the seller name (for known dealer brands).
    // This is a fallback for legacy dealer listings without an uploaded avatar.
    let sellerLogo = null;
    if (row.contact_name) {
    ...
    // Seller's uploaded avatar (from profiles.avatar_url via public_profiles).
    // Falls through to sellerLogo (brand recognition) and then initials in
    // renderCard. Use the profile's display_name as a backup for contact_name
    // when the listing pre-dates the contact-fields removal.
    const sellerAvatarUrl = sellerProfile && sellerProfile.avatar_url ? sellerProfile.avatar_url : null;
    const sellerNameFromProfile = sellerProfile && sellerProfile.display_name ? sellerProfile.display_name : null;
    ...
    return {
      ...
      seller: row.contact_name || sellerNameFromProfile || 'Private Seller',
      sellerLogo,
      sellerAvatarUrl,
  ...
  function ready() {
    ...
    _readyPromise = (async () => {
      try {
        ...
        // Batch-fetch seller avatars for all unique owner_ids. We use the
        // public_profiles view (created in migration 15) which exposes
        // display_name + avatar_url for all users in a publicly readable way.
        // This way every card and the listing detail can show the seller's
        // actual photo instead of the default emoji.
        const ownerIds = [...new Set(data.map(r => r.owner_id).filter(Boolean))];
        const profileMap = {};
        if (ownerIds.length > 0) {
          try {
            const ppRes = await window.supa
              .from('public_profiles')
              .select('id, display_name, avatar_url')
              .in('id', ownerIds);
            if (ppRes.data) {
              ppRes.data.forEach(p => { profileMap[p.id] = p; });
            }
          } catch (e) {
            console.warn('[DubiMotors] public_profiles batch fetch failed:', e.message);
          }
        }

        const liveListings = data.map(row => toLegacyShape(row, profileMap[row.owner_id] || null));
  ...
  function renderCard(l) {
    ...
    // Honor the seller's per-listing contact preferences (contact_call,
    // contact_whatsapp). These default to true in the DB if the column
    // is null (which would be the case for old demo data that pre-dates
    // the migration adding these columns). We treat null as "true" so
    // legacy listings keep working, but if the seller explicitly set
    // false, we hide the corresponding button.
    const phone = l.phone || '';
    const allowCall = l.contact_call !== false;       // null or true → allow
    const allowWa   = l.contact_whatsapp !== false;
    const waMsg = encodeURIComponent('Hi, I am interested in the ' + (l.title || 'listing') + ' listed on DubiMotors for ' + formatPrice(l.price));
    const callBtn = (phone && allowCall) ? `<a class="btn-call-icon" href="tel:${phone}" onclick="event.stopPropagation()" aria-label="Call seller" title="Call seller"><svg viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2.2' stroke-linecap='round' stroke-linejoin='round'><path d='M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.81 19.79 19.79 0 01.0 1.18 2 2 0 012 0h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 14.92z'/></svg></a>` : '';
    const waBtn   = (phone && allowWa)   ? `<a class="btn-wa-icon" href="https://wa.me/${phone.replace(/[^0-9]/g,'')}?text=${waMsg}" target="_blank" onclick="event.stopPropagation()" aria-label="WhatsApp seller" title="WhatsApp seller"><svg viewBox='0 0 24 24' fill='currentColor'><path d='M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z'/><path d='M12 0C5.373 0 0 5.373 0 12c0 2.123.554 4.118 1.528 5.845L0 24l6.335-1.508A11.942 11.942 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.818a9.818 9.818 0 01-5.006-1.374l-.36-.213-3.76.895.952-3.653-.234-.374A9.818 9.818 0 1112 21.818z'/></svg></a>` : '';
    const contactHTML = (callBtn || waBtn) ? `<div class="card-contact-btns">${callBtn}${waBtn}</div>` : '';
    // Seller avatar: prefer the seller's uploaded photo (avatar_url),
    // fall back to a brand logo we recognize, finally to initials.
    // Guard against missing l.seller — old/buggy data could have null name.
    const sellerName = l.seller || 'Private Seller';
    const sellerInitials = sellerName.split(' ').filter(Boolean).map(w => w[0]).slice(0,2).join('').toUpperCase() || '?';
    const sellerAvatarHTML = l.sellerAvatarUrl
      ? `<img class="card-seller-avatar" src="${l.sellerAvatarUrl}" alt="${sellerName}" onerror="this.replaceWith(Object.assign(document.createElement('span'),{className:'card-seller-initials',textContent:'${sellerInitials}'}))" />`
      : (l.sellerLogo
          ? `<img class="card-seller-avatar" src="${l.sellerLogo}" alt="${sellerName}" />`
          : `<span class="card-seller-initials">${sellerInitials}</span>`);
    // Location row
    const locHTML = l.location ? `<div class="card-location-row"><span class="card-location">📍 ${l.location}</span></div>` : '';
    return `
      <div class="listing-card" onclick="window.location.href='listing.html?id=${l.id}'">
        ...
        <div class="card-footer">
          <div class="card-seller-wrap">
            ${sellerAvatarHTML}
            <span class="card-seller">${sellerName}</span>
          </div>
