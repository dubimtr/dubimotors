...
const DM = (() => {
  ...
  function ready() {
    ...
    _readyPromise = (async () => {
      try {
        ...
        // Always fires — even if count is 0 — so pages can swap their loading
        // state for an empty-state rather than waiting indefinitely.
  ...
  return { listings, formatPrice, getCounts, getByCategory, getById, renderCard, ready, isLoaded: () => _loaded, toLegacyShape };
})();
